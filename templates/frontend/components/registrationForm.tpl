{**
 * plugins/themes/acadmemic_free/templates/frontend/components/registrationForm.tpl
 *
	...
	<div class="fields">
		...
		<div class="form-group middle_name">
			<label>
				...
				<input class="form-control" type="text" name="familyName" value="{$familyName|escape}" maxlength="40">
			</label>
		</div>	
